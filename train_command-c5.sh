...
commands=(
    ...
    "python train.py --dataset PEMS03 --hop 4 --batchsize 20  --loggrad 20 --cuda 1 --lr 1e-3  --stepsize 10 --epoch 50 --clamp 0.8 --extrapolation --ablation DGTV"
    "python train.py --dataset PEMS03 --hop 4 --batchsize 20  --loggrad 20 --cuda 1 --lr 1e-3  --stepsize 10 --epoch 50 --clamp 0 --extrapolation --ablation DGTV"
    "python train.py --dataset PEMS03 --hop 4 --batchsize 20  --loggrad 20 --cuda 1 --lr 1e-3  --stepsize 10 --epoch 50 --clamp -1 --extrapolation --ablation DGTV"
    "python train.py --dataset PEMS03 --hop 4 --batchsize 18  --loggrad 20 --cuda 1 --lr 1e-3  --stepsize 10 --epoch 50 --clamp 0.8 --extrapolation --ablation DGLR"
    "python train.py --dataset PEMS03 --hop 4 --batchsize 18  --loggrad 20 --cuda 1 --lr 1e-3  --stepsize 10 --epoch 50 --clamp 0 --extrapolation --ablation DGLR"
    "python train.py --dataset PEMS03 --hop 4 --batchsize 18  --loggrad 20 --cuda 1 --lr 1e-3  --stepsize 10 --epoch 50 --clamp -1 --extrapolation --ablation DGLR"

    "python train.py --dataset PEMS03 --hop 4 --batchsize 14  --loggrad 20 --cuda 1 --lr 5e-4  --stepsize 10 --epoch 50 --clamp 0 --extrapolation"
    "python train.py --dataset PEMS03 --hop 4 --batchsize 14  --loggrad 20 --cuda 1 --lr 5e-4  --stepsize 10 --epoch 50 --clamp -1 --extrapolation"
    "python train.py --dataset PEMS03 --hop 4 --batchsize 20  --loggrad 20 --cuda 1 --lr 5e-4  --stepsize 10 --epoch 50 --clamp 0.8 --extrapolation --ablation DGTV"
    "python train.py --dataset PEMS03 --hop 4 --batchsize 20  --loggrad 20 --cuda 1 --lr 5e-4  --stepsize 10 --epoch 50 --clamp 0 --extrapolation --ablation DGTV"
    "python train.py --dataset PEMS03 --hop 4 --batchsize 20  --loggrad 20 --cuda 1 --lr 5e-4  --stepsize 10 --epoch 50 --clamp -1 --extrapolation --ablation DGTV"
    "python train.py --dataset PEMS03 --hop 4 --batchsize 18  --loggrad 20 --cuda 1 --lr 5e-4  --stepsize 10 --epoch 50 --clamp 0.8 --extrapolation --ablation DGLR"
    "python train.py --dataset PEMS03 --hop 4 --batchsize 18  --loggrad 20 --cuda 1 --lr 5e-4  --stepsize 10 --epoch 50 --clamp 0 --extrapolation --ablation DGLR"
    "python train.py --dataset PEMS03 --hop 4 --batchsize 18  --loggrad 20 --cuda 1 --lr 5e-4  --stepsize 10 --epoch 50 --clamp -1 --extrapolation --ablation DGLR"
