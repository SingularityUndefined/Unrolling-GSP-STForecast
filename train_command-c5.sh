...
commands=(
    ...
    "/home/disk/qij/anaconda3/bin/python train.py --dataset PEMS03 --hop 4 --batchsize 14  --loggrad 10 --cuda 1 --lr 1e-3  --stepsize 10 --epoch 50 --clamp 0.5"
    "/home/disk/qij/anaconda3/bin/python train.py --dataset PEMS03 --hop 4 --batchsize 14  --loggrad 10 --cuda 1 --lr 1e-3  --stepsize 10 --epoch 50 --clamp 0.8"
    "/home/disk/qij/anaconda3/bin/python train.py --dataset PEMS03 --hop 4 --batchsize 14  --loggrad 10 --cuda 1 --lr 1e-3  --stepsize 10 --epoch 50 --clamp 0.5 --optim adam"
