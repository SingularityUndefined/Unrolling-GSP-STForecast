...
commands=(
    ...
    # "python train.py --dataset PEMS04 --hop 4 --batchsize 8  --loggrad 8 --cuda 0 --lr 1e-3  --stepsize 10 --epoch 50 --clamp 0.5 --ablation DGLR --extrapolation"
    ...
    "python train.py --dataset PEMS04 --hop 4 --batchsize 8  --loggrad 8 --cuda 0 --lr 1e-3  --stepsize 10 --epoch 50 --clamp 0.8 --ablation DGLR --extrapolation"
    "python train.py --dataset PEMS04 --hop 4 --batchsize 8  --loggrad 8 --cuda 0 --lr 1e-3  --stepsize 10 --epoch 50 --clamp 0 --ablation DGLR --extrapolation"
    ...
    "python train.py --dataset PEMS04 --hop 4 --batchsize 8  --loggrad 8 --cuda 0 --lr 1e-3  --stepsize 10 --epoch 50 --clamp -1 --ablation DGLR --extrapolation"
    ...
    "python train.py --dataset PEMS07 --hop 4 --batchsize 8  --loggrad 8 --cuda 0 --lr 1e-3  --stepsize 10 --epoch 50 --clamp 0.5 --ablation DGTV --extrapolation"
    "python train.py --dataset PEMS07 --hop 4 --batchsize 6  --loggrad 8 --cuda 0 --lr 1e-3  --stepsize 10 --epoch 50 --clamp 0.5 --ablation DGLR --extrapolation"
